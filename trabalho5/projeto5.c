...
void menu_options() {
  ...
  printf("02- Verificar se a árvore está cheia\n");
  printf("03- Buscar valor na árvore\n");
  printf("04- Imprimir a altura da árvore\n");
  printf("05- Remover um valor da árvore\n");
